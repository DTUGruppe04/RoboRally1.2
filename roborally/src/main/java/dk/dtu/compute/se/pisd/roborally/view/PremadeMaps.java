...
public enum PremadeMaps {
    ...
    CORRIDOR_BLITZ(new int[][]{
            {0,8,0,0,0,0,0,0,6,0},
            {11,0,0,0,20,0,0,0,0,12},
            {0,0,36,0,0,0,0,35,0,0},
            {0,0,28,13,10,10,11,22,2,0},
            {0,20,0,13,0,0,11,0,20,0},
            {0,1,0,13,0,19,11,0,0,0},
            {0,0,0,11,12,12,12,0,0,0},
            {0,0,35,22,0,0,31,37,0,0},
            {6,0,0,0,0,20,0,0,0,8},
