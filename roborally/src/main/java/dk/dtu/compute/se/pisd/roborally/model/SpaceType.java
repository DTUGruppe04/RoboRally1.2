...
public enum SpaceType {
    ...
    CHECKPOINT2("file:roborally/src/main/java/dk/dtu/compute/se/pisd/roborally/images/Checkpoint.png", new CheckPoint(2)),
    CHECKPOINT3("file:roborally/src/main/java/dk/dtu/compute/se/pisd/roborally/images/Checkpoint.png", new CheckPoint(3)),
    CHECKPOINT4("file:roborally/src/main/java/dk/dtu/compute/se/pisd/roborally/images/Checkpoint.png", new CheckPoint(4)),
    CHECKPOINT5("file:roborally/src/main/java/dk/dtu/compute/se/pisd/roborally/images/Checkpoint.png", new CheckPoint(5)),
